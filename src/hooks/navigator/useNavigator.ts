...
const useNavigatorState = () =>
{
    ...
    return { categories, doorData, setDoorData, topLevelContext, topLevelContexts, searchResult, navigatorData, favouriteRoomIds, setFavouriteRoomIds };
}
