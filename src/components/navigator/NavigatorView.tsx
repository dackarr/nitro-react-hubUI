        ...
        const linkTracker: ILinkEventTracker = {
            linkReceived: (url: string) =>
            {
                ...
                switch(parts[1])
                {
                    ...
                    case 'create':
                        setIsVisible(true);
                        CreateLinkEvent('navigator/room-creator/toggle');
                        return;
                    case 'search':
                        if(parts.length > 2)
                        {
                ...
                <NitroCardView windowPosition="DWP_NAVIGATOR" uniqueKey="navigator" className="nitro-navigator">
                    ...
                    <NitroCardContentView position="relative">
                        <NitroCardTabsView>
                            ...
                            <NitroCardTabsItemView onClick={ event => CreateLinkEvent('room-creator/toggle') }>
                        ...
                        { !isCreatorOpen &&
                            <>
                                ...
                                <Column className="pb-1" gap={ 1 } fullHeight innerRef={ elementRef } overflow="y-scroll">
