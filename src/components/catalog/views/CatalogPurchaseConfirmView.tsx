        ...
        <NitroCardView className="catalog-purchase-confirm-view no-resize" theme="primary">
            ...
            <NitroCardContentView className="text-black">
                <Flex column>
                    ...
                    <Flex gap={2} justifyContent="between" className="px-1 mt-1">
                        <Button fullWidth variant="danger" onClick={ cancel }>{ LocalizeText('generic.cancel') }</Button>
                        <Button fullWidth variant="success" onClick={ confirm }>{ LocalizeText('catalog.marketplace.confirm_title') }</Button>
                    </Flex>
                </Flex>
