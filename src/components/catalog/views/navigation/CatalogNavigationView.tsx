...
export const CatalogNavigationView: FC<CatalogNavigationViewProps> = props =>
{
    ...
    return (
        <>
            <CatalogSearchView />
            <Column fullHeight className="catalog-navigation nitro-catalog-navigation-grid-container rounded p-1" overflow="hidden">
                <AutoGrid className="nitro-catalog-main-navigation" id="nitro-catalog-main-navigation" gap={ 1 } columnCount={ 1 }>
