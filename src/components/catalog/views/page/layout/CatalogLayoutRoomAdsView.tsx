...
export const CatalogLayoutRoomAdsView: FC<CatalogLayoutProps> = props =>
{
    ...
    return (<>
        <Column fullHeight size={ 12 } overflow="hidden" className="text-black">
            <Column fullHeight justifyContent='evenly' gap={ 2 } className="nitro-room-event rounded p-1">
                <Column gap={ 2 }>
                ...
                <Column gap={ 1 }>
                    ...
                    <input type="text" className="nitro-room-event-input form-control form-control-sm" maxLength={ 64 } value={ eventName } onChange={ event => setEventName(event.target.value) } readOnly={ extended } />
                </Column>
                <Column gap={ 1 }>
                    <Text bold>{ LocalizeText('roomad.catalog_description') }</Text>
                    <textarea className="nitro-room-event-input description form-control form-control-sm" maxLength={ 64 } value={ eventDesc } onChange={ event => setEventDesc(event.target.value) } readOnly={ extended } />
                </Column>
                <Column gap={ 1 }>
