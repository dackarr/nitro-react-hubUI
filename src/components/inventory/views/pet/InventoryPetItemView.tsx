...
export const InventoryPetItemView: FC<PropsWithChildren<{ petItem: IPetItem }>> = props =>
{
    ...
    return (
        <LayoutGridItem className="align-items-center justify-content-center flex-column layout-inner" style={ { backgroundPosition: 'center center', backgroundRepeat: 'no-repeat' } } itemActive={ (petItem === selectedPet) } itemUnseen={ unseen } onMouseDown={ onMouseEvent } onMouseUp={ onMouseEvent } onMouseOut={ onMouseEvent } onDoubleClick={ onMouseEvent } { ...rest }>
