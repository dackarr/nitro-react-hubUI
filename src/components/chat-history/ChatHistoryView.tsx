...
import { Base, Flex, InfiniteScroll, NitroCardContentView, NitroCardHeaderView, NitroCardView, Text } from '../../common';
        ...
        <NitroCardView uniqueKey="chat-history" className="nitro-chat-history" theme="primary-slim">
            ...
            <NitroCardContentView innerRef={ elementRef } overflow="hidden" gap={ 1 }>
                <Flex className="layout-search">
                    ...
                    <input type="text" className="form-control search left form-control-sm" placeholder={ LocalizeText('generic.search') } value={ searchText } onChange={ event => setSearchText(event.target.value) } />
                </Flex>
                <Flex fullHeight fullWidth className='nitro-catalog-items-grid'>
